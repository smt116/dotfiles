...
hi MatchParen ctermfg=1 ctermbg=NONE cterm=NONE guifg=#cd0000 guibg=NONE gui=NONE
...
hi Pmenu ctermfg=153 ctermbg=239 cterm=NONE guifg=#bcdbff guibg=NONE gui=NONE
hi PmenuSel ctermfg=NONE ctermbg=59 cterm=NONE guifg=NONE guibg=#3f4b52 gui=NONE
hi Search ctermfg=9 ctermbg=NONE cterm=underline guifg=#d25151 guibg=NONE gui=underline
...
hi SignColumn ctermfg=247 ctermbg=234 cterm=NONE guifg=#9a9a9a guibg=#000000 gui=NONE
hi SpellBad ctermbg=NONE ctermfg=9 cterm=underline guibg=NONE guifg=#d25151 gui=underline
hi SpellCap ctermbg=NONE ctermfg=27 cterm=underline guibg=NONE guifg=#005fff gui=underline
hi SpellRare ctermbg=NONE ctermfg=89 cterm=underline guibg=NONE guifg=#87005f gui=underline
hi SpellLocal ctermbg=NONE ctermfg=64 cterm=underline guibg=NONE guifg=#5f8700 gui=underline
...
hi DiffAdd ctermfg=41 ctermbg=NONE cterm=NONE guifg=#00d75f guibg=NONE gui=NONE
hi DiffDelete ctermfg=9 ctermbg=NONE cterm=NONE guifg=#d25151 guibg=NONE gui=NONE
hi DiffChange ctermfg=231 ctermbg=NONE cterm=NONE guifg=#f0f0f0 guibg=NONE gui=NONE
...
hi NonText ctermfg=59 ctermbg=NONE cterm=NONE guifg=#414e58 guibg=NONE gui=NONE
...
hi SpecialKey ctermfg=15 ctermbg=88 cterm=NONE guifg=#ffffff guibg=#870000 gui=NONE
...
hi diffFile ctermfg=238 ctermbg=NONE cterm=NONE guifg=#444444 guibg=NONE gui=NONE
hi diffLine ctermfg=238 ctermbg=NONE cterm=NONE guifg=#444444 guibg=NONE gui=NONE
hi diffSubname ctermfg=238 ctermbg=NONE cterm=NONE guifg=#444444 guibg=NONE gui=NONE
hi gitDiff ctermfg=250 ctermbg=NONE cterm=NONE guifg=#bcbcbc guibg=NONE gui=NONE
